...
#define PS3_FIFO_RESET_SIZE	2492
...
static volatile uint32_t* Setup2D(volatile uint32_t *cmd)
{
	*(cmd++) = MTH_HDR(1,1,0x0);
	*(cmd++) = 0x31337303;
	*(cmd++) = MTH_HDR(3,1,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = 0xfeed0001;
	*(cmd++) = 0xfeed0000;
	*(cmd++) = MTH_HDR(1,2,0x0);
	*(cmd++) = 0x3137c0de;
	*(cmd++) = MTH_HDR(1,2,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = MTH_HDR(2,2,0x184);
	*(cmd++) = 0xfeed0000;
	*(cmd++) = 0xfeed0001;
	*(cmd++) = MTH_HDR(1,3,0x0);
	*(cmd++) = 0x313371c3;
	*(cmd++) = MTH_HDR(3,3,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = 0xfeed0000;
	*(cmd++) = 0xfeed0000;
	*(cmd++) = MTH_HDR(1,4,0x0);
	*(cmd++) = 0x31337a73;
	*(cmd++) = MTH_HDR(2,4,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = 0xfeed0000;
	*(cmd++) = MTH_HDR(1,5,0x0);
	*(cmd++) = 0x31337808;
	*(cmd++) = MTH_HDR(8,5,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	...
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x313371c3;
	*(cmd++) = MTH_HDR(2,5,0x2fc);
	*(cmd++) = 0x00000003;
	*(cmd++) = 0x00000004;
	*(cmd++) = MTH_HDR(1,6,0x0);
	*(cmd++) = 0x3137af00;
	*(cmd++) = MTH_HDR(1,6,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = 0x00020000; /* 43 return */
	return cmd; //(43 << 2);
}

static volatile uint32_t* Setup3D(volatile uint32_t *cmd, int chan)
{
	*(cmd++) = MTH_HDR(1,chan,0x0);
	*(cmd++) = 0x31337000;
	*(cmd++) = MTH_HDR(15,chan,0x180);
	*(cmd++) = 0x66604200;
	*(cmd++) = 0xfeed0000;
	*(cmd++) = 0xfeed0001;
	*(cmd++) = 0xfeed0000;
	...
	*(cmd++) = 0xfeed0000;
	*(cmd++) = 0xfeed0000;
	*(cmd++) = MTH_HDR(1,chan,0x60);
	*(cmd++) = 0x66616661;
	*(cmd++) = MTH_HDR(13,chan,0x200);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000121;
	*(cmd++) = 0x00000040;
	...
	*(cmd++) = 0x00000040;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(4,chan,0x280);
	*(cmd++) = 0x00000040;
	*(cmd++) = 0x00000040;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1d80);
	*(cmd++) = 0x00000003;
	*(cmd++) = MTH_HDR(18,chan,0x2b8);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x0fff0000;
	*(cmd++) = 0x0fff0000;
	...
	*(cmd++) = 0x0fff0000;
	*(cmd++) = 0x0fff0000;
	*(cmd++) = MTH_HDR(2,chan,0x1d98);
	*(cmd++) = 0x0fff0000;
	*(cmd++) = 0x0fff0000;
	*(cmd++) = MTH_HDR(1,chan,0x1da4);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x3b0);
	*(cmd++) = 0x00100000;
	*(cmd++) = MTH_HDR(1,chan,0x1454);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1ff4);
	*(cmd++) = 0x003fffff;
	*(cmd++) = MTH_HDR(6,chan,0x1fc0);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x06144321;
	*(cmd++) = 0xedcba987;
	*(cmd++) = 0x0000006f;
	...
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0xa0c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(3,chan,0xa60);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(2,chan,0xa78);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1428);
	*(cmd++) = 0x00000001;
	*(cmd++) = MTH_HDR(1,chan,0x1d88);
	*(cmd++) = 0x00001000;
	*(cmd++) = MTH_HDR(1,chan,0x1e94);
	*(cmd++) = 0x00000011;
	*(cmd++) = MTH_HDR(1,chan,0x1450);
	*(cmd++) = 0x00080003;
	*(cmd++) = MTH_HDR(1,chan,0x1d64);
	*(cmd++) = 0x02000000;
	*(cmd++) = MTH_HDR(1,chan,0x145c);
	*(cmd++) = 0x00000001;
	*(cmd++) = MTH_HDR(1,chan,0x1fe0);
	*(cmd++) = 0x00000001;
	*(cmd++) = MTH_HDR(16,chan,0xb00);
	*(cmd++) = 0x00002dc8;
	*(cmd++) = 0x00002dc8;
	*(cmd++) = 0x00002dc8;
	*(cmd++) = 0x00002dc8;
	...
	*(cmd++) = 0x00002dc8;
	*(cmd++) = 0x00002dc8;
	*(cmd++) = MTH_HDR(4,chan,0x8cc);
	*(cmd++) = 0x00000800;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(4,chan,0x240);
	*(cmd++) = 0x0000ffff;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(48,chan,0x3c0);
	*(cmd++) = 0x00010101;
	*(cmd++) = 0x00010101;
	*(cmd++) = 0x00010101;
	*(cmd++) = 0x00010101;
	...
	*(cmd++) = 0x99876666;
	*(cmd++) = 0x99abbbaa;
	*(cmd++) = MTH_HDR(2,chan,0x1738);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,7,0x0);
	*(cmd++) = 0xcafebabe;
	*(cmd++) = MTH_HDR(2,chan,0x308);
	*(cmd++) = 0x00000207;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x304);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(3,chan,0x350);
	*(cmd++) = 0x00000207;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x000000ff;
	*(cmd++) = MTH_HDR(1,chan,0x34c);
	*(cmd++) = 0x000000ff;
	*(cmd++) = MTH_HDR(3,chan,0x35c);
	*(cmd++) = 0x00001e00;
	*(cmd++) = 0x00001e00;
	*(cmd++) = 0x00001e00;
	*(cmd++) = MTH_HDR(1,chan,0x31c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x37c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x310);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x36c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x320);
	*(cmd++) = 0x80068006;
	*(cmd++) = MTH_HDR(2,chan,0x314);
	*(cmd++) = 0x00010001;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1d8c);
	*(cmd++) = 0xffffff00;
	*(cmd++) = MTH_HDR(1,chan,0x1d94);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x100);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x324);
	*(cmd++) = 0x01010101;
	*(cmd++) = MTH_HDR(1,chan,0x183c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1830);
	*(cmd++) = 0x00000405;
	*(cmd++) = MTH_HDR(2,chan,0x384);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x3f800000;
	*(cmd++) = MTH_HDR(1,chan,0x380);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0xa6c);
	*(cmd++) = 0x00000201;
	*(cmd++) = MTH_HDR(1,chan,0xa70);
	*(cmd++) = 0x00000001;
	*(cmd++) = MTH_HDR(1,chan,0xa74);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x300);
	*(cmd++) = 0x00000001;
	*(cmd++) = MTH_HDR(1,chan,0x1fec);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1fc0);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1834);
	*(cmd++) = 0x00000901;
	*(cmd++) = MTH_HDR(1,chan,0x3b8);
	*(cmd++) = 0x00000008;
	*(cmd++) = MTH_HDR(1,chan,0x374);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x378);
	*(cmd++) = 0x00001503;
	*(cmd++) = MTH_HDR(1,chan,0x1ee0);
	*(cmd++) = 0x3f800000;
	*(cmd++) = MTH_HDR(1,chan,0xa68);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(2,chan,0xa78);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1dac);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1db0);
	*(cmd++) = 0xffffffff;
	*(cmd++) = MTH_HDR(2,chan,0x8c0);
	*(cmd++) = 0x10000000;
	*(cmd++) = 0x10000000;
	*(cmd++) = MTH_HDR(1,chan,0x368);
	*(cmd++) = 0x00001d01;
	*(cmd++) = MTH_HDR(3,chan,0x330);
	*(cmd++) = 0x00000207;
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x000000ff;
	*(cmd++) = MTH_HDR(1,chan,0x32c);
	*(cmd++) = 0x000000ff;
	*(cmd++) = MTH_HDR(3,chan,0x33c);
	*(cmd++) = 0x00001e00;
	*(cmd++) = 0x00001e00;
	*(cmd++) = 0x00001e00;
	*(cmd++) = MTH_HDR(1,chan,0x328);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1a08);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1a1c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1a0c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1a14);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1a28);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1a3c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1a2c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1a34);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1a48);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1a5c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1a4c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1a54);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1a68);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1a7c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1a6c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1a74);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1a88);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1a9c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1a8c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1a94);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1aa8);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1abc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1aac);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1ab4);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1ac8);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1adc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1acc);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1ad4);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1ae8);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1afc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1aec);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1af4);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1b08);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1b1c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1b0c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1b14);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1b28);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1b3c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1b2c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1b34);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1b48);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1b5c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1b4c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1b54);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1b68);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1b7c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1b6c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1b74);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1b88);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1b9c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1b8c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1b94);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1ba8);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1bbc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1bac);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1bb4);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1bc8);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1bdc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1bcc);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1bd4);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x1be8);
	*(cmd++) = 0x00030101;
	*(cmd++) = MTH_HDR(1,chan,0x1bfc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1bec);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x1bf4);
	*(cmd++) = 0x02052000;
	*(cmd++) = MTH_HDR(1,chan,0x348);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1740);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x1680);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1744);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x1684);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1748);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x1688);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x174c);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x168c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1750);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x1690);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1754);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x1694);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1758);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x1698);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x175c);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x169c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1760);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16a0);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1764);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16a4);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1768);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16a8);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x176c);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16ac);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1770);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16b0);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1774);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16b4);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1778);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16b8);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x177c);
	*(cmd++) = 0x00000002;
	*(cmd++) = MTH_HDR(1,chan,0x16bc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(2,chan,0xa00);
	*(cmd++) = 0x10000000;
	*(cmd++) = 0x10000000;
	*(cmd++) = MTH_HDR(2,chan,0x394);
	*(cmd++) = 0x00000000;
	*(cmd++) = 0x3f800000;
	*(cmd++) = MTH_HDR(8,chan,0xa20);
	*(cmd++) = 0x45000000;
	*(cmd++) = 0x45000000;
	*(cmd++) = 0x3f000000;
	*(cmd++) = 0x00000000;
	...
	*(cmd++) = 0x3f000000;
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1d7c);
	*(cmd++) = 0xffff0000;
	*(cmd++) = MTH_HDR(1,chan,0x182c);
	*(cmd++) = 0x00001b02;
	*(cmd++) = MTH_HDR(1,chan,0x1d90);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x370);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1828);
	*(cmd++) = 0x00001b02;
	*(cmd++) = MTH_HDR(1,chan,0x3bc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1db4);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1ee4);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1ee8);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1838);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x147c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1e98);
	*(cmd++) = 0x01000000;
	*(cmd++) = MTH_HDR(1,chan,0x1478);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1ff0);
	*(cmd++) = 0x0000ffff;
	*(cmd++) = MTH_HDR(1,chan,0x17cc);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x908);
	*(cmd++) = 0x00000101;
	*(cmd++) = MTH_HDR(1,chan,0x91c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x90c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x914);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x928);
	*(cmd++) = 0x00000101;
	*(cmd++) = MTH_HDR(1,chan,0x93c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x92c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x934);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x948);
	*(cmd++) = 0x00000101;
	*(cmd++) = MTH_HDR(1,chan,0x95c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x94c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x954);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x968);
	*(cmd++) = 0x00000101;
	*(cmd++) = MTH_HDR(1,chan,0x97c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x96c);
	*(cmd++) = 0x00060000;
	*(cmd++) = MTH_HDR(1,chan,0x974);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x238);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1d78);
	*(cmd++) = 0x00000001;
	*(cmd++) = MTH_HDR(1,chan,0x142c);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1ff8);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(1,chan,0x1fe8);
	*(cmd++) = 0x00000000;
	*(cmd++) = MTH_HDR(2,7,0x19c);
	*(cmd++) = 0xfeed0000;
	*(cmd++) = 0xfeed0001;
	*(cmd++) = 0x00020000; /* 623 return */
	return cmd;
}
...
static int ps3gpu_restore_state(void)
{
	...
	u32 *fifo_prev;
	volatile uint32_t *next_cmd;
	uint32_t next_offset;
	int retval = 0;
	
	fifo->curr = fifo->start;
	fifo_prev = fifo->curr;
	next_cmd = Setup3D(fifo->sub_program,0);
	next_offset = (next_cmd-fifo->sub_program) * sizeof(u32);;
	Setup2D(next_cmd);
	ps3fb.fifo.sub_program[GPU_USER_DEBUG] = 0; // mark error
	fifo->curr[0] =  GPU_IOIF | 0x00000002;
	fifo->curr[1] =  (GPU_IOIF + next_offset) | 0x00000002;
	fifo->curr += 2;
...
static int read_rtc(struct ps3gpu_ioctl_time_rtc *arg)
{
	int result;
	u64 rtc_val,tb_val;
	result = lv1_get_rtc(&rtc_val, &tb_val);
	arg->base = tb_val;
	arg->time = rtc_val + RTCAdj;
	return result;
}
...
static int ps3fb_ioctl(struct fb_info *info, unsigned int cmd, unsigned long arg)
{
	...
	switch (cmd) {
		...
		case PS3FB_IOCTL_GETMODE: {
			u32 val = ps3av_get_mode();
			dev_dbg(info->device, "PS3FB_IOCTL_GETMODE:%x\n", val);
			if (!copy_to_user((void __user *)arg, &val, sizeof(val))) retval = 0;
			break;
			}
		case PS3FB_IOCTL_SCREENINFO: {
			...
			if (!copy_to_user((void __user *)arg, &res, sizeof(res))) retval = 0;
			break;
			}
		case PS3FB_IOCTL_ON:
		...
		case PS3FB_IOCTL_FSEL: {
			u32 val;
			if (copy_from_user(&val, (void __user *)arg, sizeof(val))) break;
		...
		case PS3GPU_IOCTL_INFO:	{
			...
			ext_res.reset_size = PS3_FIFO_RESET_SIZE; /* in bytes */
			...
			if (!copy_to_user((void __user *)arg, &ext_res, sizeof(ext_res)))
				retval = 0;
			break;
			}
		...
		case PS3GPU_IOCTL_ENTER:
			...
			retval=0;
			break;
		case PS3GPU_IOCTL_TIME_RTC:
			if(!read_rtc((struct ps3gpu_ioctl_time_rtc *)arg) ) {
				retval=0;
			}
			break;
